#This is free, open-source software under the (lenient) GNU GPLv3. It comes with no warranty. Its inputs are contained in the scrip as data frames containing fibroblast chromosome aberration (CA) data used in [Cacao E, M Hada, PB Saganti, KA George and FA Cucinotta. "Relative Biological Effectiveness of HZE Particles for Chromosomal Exchanges and Other Surrogate Cancer Risk Endpoints." PLoS One 11(4): e0153998. (2016)], "16Cacao" for short. The script outputs graphs and numerical results for a synergy article (Dae Woong Ham et al., Radiation Research). The script was written by Dae Woong Ham between Sept. 2016 and May 2017. Quality control by Rainer K. Sachs May-Sept. 2017.
...
# Create data frames that store the data summarized in 16Cacao. 
